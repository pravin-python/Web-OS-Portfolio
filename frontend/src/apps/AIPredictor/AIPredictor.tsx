...
import { simulatePrediction, type PredictionResult } from '../../services/aiService';
                ...
                {phase === 'idle' && (
                    <>
                        <div
                            ...
                            onDrop={(e) => { e.preventDefault(); setDragOver(false); runPrediction(); }}
                        >
                        ...
                        <div style={{ color: '#666', fontSize: 12 }}>— or try a sample —</div>
                ...
                {phase === 'result' && result && (
                    <div className="ai-result">
                        <div className="ai-result-type">
                            ...
                            <span className={`ai-confidence ${confidenceClass(result.confidence)}`}>
                                {result.confidence}%
                            </span>
                        </div>
