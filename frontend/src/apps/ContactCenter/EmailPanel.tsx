...
export const EmailPanel: React.FC = () => {
    ...
    const handleOpenMailClient = () => {
        ...
        const body = encodeURIComponent('Hello Pravin,\n\nI came across your portfolio and would like to connect.\n\n');
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full p-6 space-y-6">
            ...
            <div className="text-center space-y-1">
                <h2 className="text-lg font-bold text-slate-800 dark:text-slate-100">Email Contact</h2>
            ...
            <div className="w-full max-w-sm bg-slate-50 dark:bg-slate-800/60 rounded-xl p-4 border border-slate-200/50 dark:border-slate-700/50 text-center">
                <span className="font-mono text-sm text-slate-700 dark:text-slate-300 select-all">{CONTACT.email}</span>
            </div>
