...
To ensure no broken code enters the `master` or `develop` branches, please configure the following Branch Protection Rules in your GitHub repository settings.
...
4. In the **Branch name pattern** field, type `master` (and repeat for `develop` if applicable).
