...
export const EDUCATION: EducationEntry[] = [
    {
        ...
        years: '2019 – 2022',
        subjects: ['Data Structures', 'Database Systems', 'Networking', 'Operating Systems', 'Web Technologies', 'C / C++ Programming'],
        icon: '🎓',
    },
    {
        id: 'edu-2',
        ...
        years: '2022 – Present',
        subjects: ['Supervised Learning', 'Computer Vision', 'NLP Fundamentals', 'Deep Learning Basics', 'Data Processing Pipelines'],
        icon: '🧠',
    },
];
...
export const CAREER_TIMELINE: CareerEntry[] = [
    ...
    },
    {
        ...
        tools: ['Scikit-learn', 'Pandas', 'NumPy', 'Matplotlib', 'TensorFlow Basics'],
        icon: '🤖',
    },
    {
        id: 'career-3',
        ...
        tools: ['React', 'TypeScript', 'Vite', 'Tailwind CSS', 'Zustand', 'WebSocket'],
        icon: '💻',
    },
];
...
export const PROJECTS: Project[] = [
    {
        ...
        description: 'Extracts structured data from scanned invoices using OCR and post-processing pipelines.',
        tech: ['Python', 'OpenCV', 'EasyOCR', 'Pandas'],
        problem: 'Manual data entry from hundreds of invoices was slow and error-prone.',
        learned: 'Advanced image preprocessing, text extraction accuracy improvement, and data cleaning techniques.',
        icon: '📄',
    },
    {
        id: 'proj-2',
        name: 'Web-OS Portfolio',
        description: 'A fully interactive operating-system-style portfolio built with React, featuring windows, a taskbar, and multiple applications.',
        tech: ['React', 'TypeScript', 'Tailwind CSS', 'Zustand', 'Vite'],
        problem: 'Traditional portfolios feel static — this creates an immersive, memorable experience.',
        learned: 'Complex state management, window manager architecture, and advanced CSS layout techniques.',
        icon: '🖥️',
    },
    {
        id: 'proj-3',
        name: 'Security Analysis Toolkit',
        description: 'Browser-based security toolkit for password analysis, URL scanning, hash generation, and log analysis.',
        tech: ['TypeScript', 'React', 'Web Crypto API'],
        problem: 'Quick security checks required multiple external tools — this consolidates them.',
        learned: 'Cryptographic hashing, URL pattern analysis, and security log parsing.',
        icon: '🔐',
    },
    {
        id: 'proj-4',
        name: 'AI Prediction System',
        description: 'ML-based prediction interface for classification and regression tasks with real-time feedback.',
        tech: ['Python', 'Scikit-learn', 'React', 'REST API'],
        problem: 'Making ML predictions accessible to non-technical users.',
        learned: 'Model deployment, feature engineering, and building intuitive ML interfaces.',
        icon: '🤖',
    },
    {
        id: 'proj-5',
        name: 'Data Processing Pipeline',
        description: 'Automated pipeline for cleaning, transforming, and analyzing large datasets.',
        tech: ['Python', 'Pandas', 'NumPy', 'Matplotlib'],
        problem: 'Repetitive data cleaning tasks consumed hours of manual effort.',
        learned: 'Efficient data transformation patterns and pipeline architecture.',
        icon: '📊',
    },
];

export const ACHIEVEMENTS: Achievement[] = [
    { id: 'ach-1', icon: '⚙️', title: 'Built OCR Extraction Pipeline', description: 'End-to-end OCR system processing hundreds of documents automatically.' },
    { id: 'ach-2', icon: '📊', title: 'Automated Data Processing', description: 'Created automated data cleaning tools reducing manual effort by 80%.' },
    { id: 'ach-3', icon: '🔐', title: 'Security Detection Tools', description: 'Implemented URL scanning and log analysis security toolkit.' },
    { id: 'ach-4', icon: '🖥️', title: 'Interactive OS Portfolio', description: 'Built a complete operating-system-style portfolio from scratch.' },
    { id: 'ach-5', icon: '🎮', title: 'AI Game Opponents', description: 'Implemented minimax AI for TicTacToe with difficulty levels.' },
    { id: 'ach-6', icon: '🚀', title: 'Full-Stack Development', description: 'Delivered multiple projects spanning frontend, backend, and ML.' },
];

export const LEARNING_ROADMAP: LearningItem[] = [
    { id: 'learn-1', topic: 'Advanced Machine Learning', status: 'In Progress', progress: 45, icon: '🧠' },
    { id: 'learn-2', topic: 'System Design', status: 'Researching', progress: 25, icon: '🏗️' },
    { id: 'learn-3', topic: 'Cyber Security', status: 'Practicing', progress: 40, icon: '🔐' },
    { id: 'learn-4', topic: 'Deep Learning & Neural Nets', status: 'In Progress', progress: 30, icon: '🔬' },
    { id: 'learn-5', topic: 'Cloud & DevOps', status: 'Researching', progress: 15, icon: '☁️' },
];
...
export type TabId = 'overview' | 'education' | 'career' | 'experience' | 'skills' | 'techstack' | 'projects' | 'achievements' | 'learning' | 'resume';
