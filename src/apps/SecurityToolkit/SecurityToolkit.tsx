        ...
        <div className="stk-result-card animate-in">
          ...
          <div className="stk-reasons">
            {result.reasons.map((r, i) => (
              <div key={i} className="stk-reason">
                • {r}
              </div>
            ))}
          </div>
          ...
          <div style={{ marginTop: 10 }}>
            {result.checks.map((c, i) => (
              ...
              >
                ...
                <span
                  style={{ color: c.passed ? "#666" : "#ffab91", fontSize: 11 }}
                >
                  {c.detail}
                </span>
              </div>
  ...
  return (
    <div className="stk-panel">
      <div className="stk-result-card">
        <h4 style={{ margin: "0 0 10px", color: "#00d2ff" }}>
          📋 auth.log Analysis
        </h4>
        <div className="stk-kv">
        ...
        {analysis.flaggedIPs.length > 0 && (
          <div style={{ marginTop: 12 }}>
            <h5 style={{ color: "#ff5252", margin: "0 0 6px" }}>
              🚨 Flagged IPs
            </h5>
        ...
        {analysis.alerts.length > 0 && (
          <div className="stk-alerts">
            {analysis.alerts.map((a, i) => (
              <div key={i} className="stk-alert-line">
                {a}
              </div>
            ))}
          </div>
