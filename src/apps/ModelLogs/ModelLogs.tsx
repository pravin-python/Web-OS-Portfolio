...
export const ModelLogs: React.FC = () => {
    ...
    if (!data) return <div className="ml-root"><p>Failed to load training data.</p></div>;
    ...
    return (
        <div className="ml-root">
            ...
            <div className="ml-info-card">
                ...
                <div className="ml-info-grid">
                    ...
                    <div className="ml-info-item">
                        ...
                        <span className="ml-info-value">{data.dataset_size.toLocaleString()} samples</span>
                    </div>
                    <div className="ml-info-item">
            ...
            <div className="ml-chart-section">
                <h3 className="ml-section-title">Training Progress — Validation Accuracy</h3>
