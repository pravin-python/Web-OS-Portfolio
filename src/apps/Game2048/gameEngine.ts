 ...
 */
function slideLine(line: (TileData | null)[]): { result: (TileData | null)[]; scored: number } {
...
function moveLeft(board: Board): MoveResult {
    ...
    return { board: newBoard, scoreGained: totalScored, moved: !boardsEqual(board, newBoard) };
}
